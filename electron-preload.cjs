...
contextBridge.exposeInMainWorld('escapeRoom', {
  ...
  loadRoomTemplates: () => ipcRenderer.invoke('escape-room:load-room-templates'),
  saveRoomTemplates: (templates) => ipcRenderer.invoke('escape-room:save-room-templates', templates),
});